 ...
 */
/*
	22jul15 zig - add option to hide the featured image. 
*/
global $flatsome_opt;
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( has_post_thumbnail() && get_post_meta($post->ID, 'Hide featured image', true)!='true' ) { // check if the post has a Post Thumbnail assigned to it. ?>
