 ...
 */
/* Mods  
* 2Sept2014 zig:  if nothing in sidebar, dont display it (uses widget logic to determine)
*/
...
<div class="large-12 columns">
    ...
    <div class="right">
    <?php /* zig if ( have_posts() ) : do_action( 'woocommerce_before_shop_loop' ); ?><?php endif; */ ?>
    </div><!-- .right -->
</div><!-- .breadcrumb-row -->
