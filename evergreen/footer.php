 ...
 */
/* mods
 *  zig - use php date(Y)  for copyright in right links 
 */
global $flatsome_opt;
?>
...
<div class="row">
	<div class="large-12 columns">
		...
		<div class="right">
				<?php if(isset($flatsome_opt['footer_right_text'])){ echo "Copyright ".date('Y')." © ".do_shortcode($flatsome_opt['footer_right_text']);} else {echo 'Define right footer text in Theme Option Panel';} ?>
		</div>
	</div><!-- .large-12 -->
</div><!-- .row-->
</div><!-- .absolute-footer -->
